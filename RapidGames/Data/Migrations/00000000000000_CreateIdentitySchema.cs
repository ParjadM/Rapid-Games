...
namespace RapidGames.Data.Migrations
{
    public partial class CreateIdentitySchema : Migration
    {
        ...
        {
            // Create AspNetRoles table with MySQL-compatible column types.
            ...
            // Create AspNetUsers table with MySQL-friendly column definitions.
            migrationBuilder.CreateTable(
                name: "AspNetUsers",
                columns: table => new
                {
                    ...
                    // Change nvarchar(max) to TEXT
                    SecurityStamp = table.Column<string>(type: "TEXT", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "TEXT", nullable: true),
                    // Change nvarchar(max) column to TEXT
                    PhoneNumber = table.Column<string>(type: "TEXT", nullable: true),
                    PhoneNumberConfirmed = table.Column<bool>(nullable: false),
                    TwoFactorEnabled = table.Column<bool>(nullable: false),
                    // For LockoutEnd, you might change the type to datetime(6) if needed
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderDisplayName = table.Column<string>(type: "TEXT", nullable: true), // Updated here
                    UserId = table.Column<string>(type: "varchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "TEXT", nullable: true)   // <-- Updated column type
                },
                constraints: table =>
                {
